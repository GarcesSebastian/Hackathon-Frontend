...
export function ChatMessage({ role, content }: ChatMessageProps) {
  return (
    <div >
      <div className="w-10 rounded-lg bg-primary text-primary-foreground flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-dialpad">
